...
export const translations = {
  de: {
    ...
    dispatch: {
      ...
      whatsapp: 'WhatsApp',
      chatNote: 'Ihsan liest und antwortet auf seinem WhatsApp — Ihre Nachrichten werden direkt weitergeleitet',
  ...
  en: {
    ...
    dispatch: {
      ...
      whatsapp: 'WhatsApp',
      chatNote: 'Ihsan reads and replies on his WhatsApp — your messages are forwarded directly',
  ...
  pl: {
    ...
    dispatch: {
      ...
      whatsapp: 'WhatsApp',
      chatNote: 'Ihsan czyta i odpowiada na swoim WhatsApp — Twoje wiadomości są przekazywane bezpośrednio',
